...
const callbackKey = require('./CallbackKey.js')
...
Client.prototype.getTransactions = function (accountId, callback) {
  const opts = {
...
Client.prototype.getAccount = function (accountId, callback) {
  const opts = {
...
Client.prototype.verifyCallback = function (body, signature) {
  ...
  return verifier.verify(callbackKey, signature, 'base64')
}
